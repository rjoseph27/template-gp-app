...
const routes: Routes = [
    ...
    { path: `${ClientRoutes.gpOrders}`, children: [
        ...
        { path: `${ClientRoutes.gpTracking}`, component: ClientGpTrackingComponent, pathMatch: 'full', resolve: { trip: TrackingResolver, tasks: ClientTasksResolver, userInfo: ClientApplicationResolver }},
    ] },
    { path: `${ClientRoutes.tripList}`, children: [
        ...
        { path: `${ClientRoutes.plannedTrip}`, component: ClientPlannedTripComponent, pathMatch: 'full', resolve: { tripDetails: ClientTripInfoResovler, userInfo: ClientApplicationResolver } },
        { path: `${ClientRoutes.confirmedTrip }`, component: ClientConfirmedTripComponent, pathMatch: 'full', resolve: { tripDetails: ClientTripInfoResovler, userInfo: ClientApplicationResolver }},
        { path: `${ClientRoutes.tripDone}`, component: ClientTripDoneComponent, pathMatch: 'full', resolve: { tripDetails: ClientTripInfoResovler, userInfo: ClientApplicationResolver }},
    ] },
